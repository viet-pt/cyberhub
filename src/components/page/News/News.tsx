...
const News = ({ data, relateList }: Iprops) => {
  return (
    <div className="container">
      <div className="text-[17.5px] py-6 lg:py-12 lg:w-3/4 mx-auto font-roboto mobile:px-2">
        ...
        <div className="lg:w-3/4">
          ...
          <div dangerouslySetInnerHTML={{ __html: data.content }} className="border-b pb-12 content"></div>
